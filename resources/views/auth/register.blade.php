...
<head>
    ...
    <title>Register - Trading Strategy Tracker</title>
...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6 bg-white dark:bg-gray-800 shadow rounded-lg p-8" method="POST" action="{{ route('register') }}">
            @csrf
